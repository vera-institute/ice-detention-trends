...
## About the Data
This dashboard primarily draws from ICE detention datasets obtained through Freedom of Information Act (FOIA) requests by David Hausman, assistant professor of law, University of California, Berkeley, the American Civil Liberties Union (ACLU), and the [Deportation Data Project](https://deportationdata.org/). Vera launched the initial version of this dashboard in August 2023. Vera subsequently updated the tool multiple times to include more recent data, doing so in July 2025, December 2025, April 2026, and September 2026. The data includes detention history information for every person in ICE custody during this time. 
...
Vera later received updated datasets (“Dataset II”, “Dataset III”, and “Dataset IV”) that included anonymized identifiers that linked records across a person’s detention history. These newer datasets are nearly identical in form to the original dataset, with some exceptions requiring a revised method of calculating detention population statistics, as described in Vera’s [technical appendix](https://vera-institute.files.svdcdn.com/production/downloads/dashboard_appendix.pdf). One notable limitation is that ICE largely excluded medical facilities from Dataset IV, meaning that population numbers for medical facilities are only available for October 1, 2008, through September 30, 2024. These facilities therefore show as “inactive” facilities on the map after September 2024, though their status is unknown after this period. Vera used these different datasets to calculate statistics for different time periods for the current update to this dashboard with some exceptions explained in the technical appendix: 

Dataset I: October 1, 2008, through September 30, 2013; 

Dataset II: October 1, 2013, through September 30, 2023; 

Dataset III: October 1, 2023, through September 30, 2024; 

Dataset IV: October 1, 2024, through August 5, 2026. 

Differences in facility populations before and after the respective date boundaries (i.e., from September 30 to October 1, 2013; from September 30 to October 1, 2023; and from September 30 to October 1, 2024) may at least partially reflect differences in how ICE compiled the different datasets, rather than a population change alone. Additionally, in previous versions of the dashboard, Vera used earlier releases of the Deportation Data Project’s datasets to calculate statistics between October 1, 2024 through March 10, 2025; historical data for this period may have changed slightly since the previous dashboard update, as it uses a more recent updated dataset from the Deportation Data Project. Notably, statistics for medical facilities after October 1, 2024 which previously appeared on the dashboard are now unavailable due to ICE’s omission of these facilities from more recent datasets. 
...
See the [technical appendix](https://vera-institute.files.svdcdn.com/production/downloads/dashboard_appendix.pdf) for more detail about Vera’s classification of facility types.
...
For more information about the data and Vera's methodology, see the accompanying [technical appendix](https://vera-institute.files.svdcdn.com/production/downloads/dashboard_appendix.pdf).
...
## `national.csv`
National population statistics for each day between October 1, 2008, and March 10, 2026, including midnight population, 24-hour population, book-ins, and book-outs.
