...
Vera later received updated datasets (“Dataset II”, “Dataset III”, “Dataset IV”, and “Dataset V”) that included anonymized identifiers that linked records across a person’s detention history. These newer datasets are nearly identical in form to the original dataset, with some exceptions requiring a revised method of calculating detention population statistics, as described in Vera’s [technical appendix](https://vera-institute.files.svdcdn.com/production/downloads/dashboard_appendix.pdf). One notable limitation is that Dataset V excluded medical facilities, meaning that population numbers for medical facilities are only available for October 1, 2008, through September 30, 2025. These facilities therefore show as “inactive” facilities on the map after September 2025. Vera used these different datasets to calculate statistics for different time periods, with some exceptions explained in the technical appendix:
- Dataset I: October 1, 2008, through September 30, 2013;
- Dataset II: October 1, 2013, through September 30, 2023; 
- Dataset III: October 1, 2023, through May 30, 2025;
- Dataset IV: June 1, 2025, through October 15, 2025; and
- Dataset V: October 1, 2025, through March 10, 2026.

Differences in facility populations before and after the respective date boundaries (i.e., from September 30 to October 1, 2013; from September 30 to October 1, 2023; from May 31 to June 1, 2025; and from September 30 to October 1, 2025) may at least partially reflect differences in how ICE compiled the different datasets, rather than a population change alone.
