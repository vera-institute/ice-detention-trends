...
This agreement ("Agreement") is entered into between the Vera Institute of Justice, Inc. ("Vera") and the individual(s) (each a "Recipient") who download the ICE Detention Trends Dataset (the "Dataset").

Vera is willing to grant Recipient access to the Dataset on the following terms:
